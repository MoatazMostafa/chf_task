...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class IoLibraryAccessors extends SubDependencyFactory {
        private final IoInsertLibraryAccessors laccForIoInsertLibraryAccessors = new IoInsertLibraryAccessors(owner);

        public IoLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Returns the group of libraries at io.insert
         */
        public IoInsertLibraryAccessors getInsert() {
            return laccForIoInsertLibraryAccessors;
        }

    }

    public static class IoInsertLibraryAccessors extends SubDependencyFactory {

        public IoInsertLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: startupRuntime (1.1.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
